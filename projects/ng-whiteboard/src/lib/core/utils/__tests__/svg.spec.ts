...
describe('SVG Utils', () => {
  ...
  describe('calculateBoundingBox', () => {
    it('should return default bounding box for empty input', () => {
    ...
    it('should calculate correct bounding box for single point', () => {
      ...
      expect(result).toEqual({ maxX: 10, maxY: 20, minX: 10, minY: 20, width: 0, height: 0 });
    });
    ...
    it('should calculate correct bounding box for multiple points', () => {
      ...
      expect(result).toEqual({ maxX: 30, maxY: 40, minX: 10, minY: 20, width: 20, height: 20 });
    });
  });
  ...
  describe('defaultStrokeOptions', () => {
    it('should have correct default values', () => {
      expect(defaultStrokeOptions).toEqual({
        size: 1,
        smoothing: 1,
        thinning: 0,
        streamline: 1,
